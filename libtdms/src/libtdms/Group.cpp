...
void Group::addChannel(std::shared_ptr<Channel> channel)
{
    channels.push_back(channel);
}

std::shared_ptr<Channel> Group::getChannel(const std::string &name)
{
...
const std::shared_ptr<Channel> Group::getChannel(const std::string &name) const
{
